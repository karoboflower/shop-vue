  ...
  <div class="window_box">
    <ul>
      ...
      <li class="flex_type d_start">
        <wang-editor @getContent="getContent" :defaultContent="content"></wang-editor>
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    content: {
      get: function () {
        return this.defaultData.params.content;
      },
      set: function (val) {
        this.defaultData.params.content = val;
      }
    },
    choseColor: {
      get: function () {
  ...
  methods: {
    ...
    changStyle () {
      this.$store.commit("incrementCompListItem", {
        type: 'style',
        value: {
          background: this.choseColor, paddingLeft: this.paddingLeft / 2, paddingTop: this.paddingTop / 2        }
      });
    },
    getContent (content) {
...
.window_box /deep/ .w-e-toolbar {
  flex-wrap: wrap;
}
.window_box /deep/ .w-e-text {
  width: 100%;
}
.window_box /deep/ .editor {
  width: 100%;
}
.window_box /deep/ .editor .editor {
  width: 100%;
}
</style>
