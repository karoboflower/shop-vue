    ...
    <ul class="d_btw">
      ...
      <li class="page">
        ...
        <ul class="page_cnt" >
          ...
          > <div slot="del" class="del_com" v-if="index==selectedIndex" @click="del(index)">删除</div></li> -->
           <li
            :is="item.component"
            :defaultData="item.default"
            v-for="(item,index) in compList"
            :key="index"
            @click.native="editItem(item.val,index)"
          >
            <div slot="del" class="del_com" v-if="index==setI" @click="del(index)" ref="del">删除</div>
          </li>
      ...
      <li class="set">
       ...
       <swiper v-if="componentType=='swiperComponent'" :defaultData="compList[selectedIndex]"  @changeData="changeSwiper"></swiper>
          <swiper v-if="flag==='swiperComponent'"></swiper>
          <photo v-if="flag==='photo'"></photo>
          <title v-if="flag==='title'"></title>
        </div>
      </li>
    </ul>
    <!-- 底部 -->
